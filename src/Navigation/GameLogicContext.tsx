...
export const GameLogicProvider = ({children}: {children: React.ReactNode}) => {
  ...
  // username badlida myName sync garne + leaderboard entry pani update garne
  useEffect(() => {
    if (
      ...
      if (!isFirstLoad) {
        // yo pahilo mount hoina — actual username change ho,
        // leaderboard ma pani naya name update garne
